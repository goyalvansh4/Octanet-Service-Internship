...
const HireMe = () => {
  return (
    <section className="bg_transprent flex flex-col justify-center bg-blend-multiply py-12">
      <div className="row py-4">
        <div className="col-12 text-center flex flex-col gap-8">
          <div className="section-title flex flex-col gap-4">
            <h4 className="text-bold leading-normal text-3xl title-dark title mb-2">
              I Am Available For Freelancer Projects.
            </h4>
            <p className="text-medium text-lg title-dark mx-auto mb-0 para-desc">
              Obviously Im a Web Designer. Experienced with all stages of the
              development cycle for dynamic web projects.
            </p>
            <div className="mt-4 pt-2">
              {/* <a
                className="bg-[#fa6e39] text-lg text-[#fff] px-6 py-4 rounded-lg"
                href="#"
              >
                Hire me
              </a> */}
