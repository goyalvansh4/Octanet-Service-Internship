        ...
        <div className=" flex flex-col gap-2 skills">
          <div className="skill_name">
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm font-medium text-[#FFCE17]">95%</span>
            </div>
          ...
          <div className="skill_name">
            <div className="flex justify-between mb-1">
              <span className="text-base font-medium text-[#7CEAD5] ">CSS</span>
              <span className="text-sm font-medium text-[#7CEAD5]">85%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
              <div
          ...
          <div className="skill_name">
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm font-medium text-[#2F6AA4]">75%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
              <div
          ...
          <div className="skill_name">
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm font-medium text-[#FF975E]">65%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
              <div
          ...
          <div className="skill_name">
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm font-medium text-[#9533C8]">55%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
              <div
          ...
          <div className="skill_name">
            <div className="flex justify-between mb-1">
              <span className="text-base font-medium text-[#5EEC0B] ">SQL</span>
              <span className="text-sm font-medium text-[#5EEC0B]">40%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
              <div
          ...
          <div className="skill_name">
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm font-medium text-red-700">35%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
              <div
